...
apt-get update
apt-get install --yes   gcc-4.8 gcc-5 gcc-6 gcc-7 gcc-8
apt-get install --yes   g++-4.8 g++-5 g++-6 g++-7 g++-8
apt-get install --yes   gfortran-4.8 gfortran-5 gfortran-6 gfortran-7 gfortran-8

# compile for each version
for VERSION in 4.8 5 6 7 8
do

...
#run mex-mess mess_lint code checker
${MROOT}/bin/matlab -nodesktop -nojvm -debug -r "rehash toolboxcache; addpath('$HOME'); run matlab/mess_path.m; ret=mess_lint(); exit(ret)"

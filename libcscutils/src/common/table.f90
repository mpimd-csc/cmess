MODULE CSC_TABLE
    ...
    ENUM, BIND(C)
        ENUMERATOR :: CSC_TABLE_INTEGER = 0, CSC_TABLE_FLOAT = 1, CSC_TABLE_STRING = 2
    END ENUM

    ENUM, BIND(C)
        ENUMERATOR :: CSC_TABLE_CENTER = 0, CSC_TABLE_LEFT = 1, CSC_TABLE_RIGHT = 2
    END ENUM
    ...
    INTERFACE
        FUNCTION CSC_TABLE_NEW( CONTINOUS_PRINT ) BIND(C,name="csc_table_new")
            IMPORT

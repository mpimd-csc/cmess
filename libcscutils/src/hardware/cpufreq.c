...
unsigned long csc_cpufreq_freq(unsigned int cpu) { return 0;}
int csc_cpufreq_set(unsigned int cpu, unsigned long freq) { return 0; }
unsigned long *csc_cpufreq_available_freq(unsigned int cpu) { return NULL; }
int csc_cpufreq_governor_available(unsigned int cpu, const char *governor) { return 0; }
char * csc_cpufreq_available_governors(char*buffer, size_t maxlen, unsigned int cpu, void **state){return NULL;}
int csc_cpufreq_set_governor(unsigned int cpu, char * governor) { return 0; }
int csc_cpufreq_governor_check(unsigned int cpu, char *governor) { return 0; }
#endif

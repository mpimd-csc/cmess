...
/**
 * @file matlab/c_interface/lrcfadi/mex_mess_lradi.c
 * @brief
 * @author @mbehr
 *
 */
...
void mex_mess_lradi( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    //eqn = mess_equation_from_mexmess(prhs[0], prhs[1], &memlist, MESS_EQN_GLYAP);
    eqn = mess_equation_from_mexmess(myprhs0, myprhs1, memlist, MESS_EQN_GLYAP);

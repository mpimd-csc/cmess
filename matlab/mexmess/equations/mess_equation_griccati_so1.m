% MESS_EQUATION_GRICCATI_SO1 Class represents a Second Order system Riccati Equation.
%
%   MESS_EQUATION_GRICCATI_SO1 represents a Second Order system:
%
%   M x''  +  D x' + K x = Bu,
%                      y = Cx
%
...
%                  y  =  C x.
%
%   MESS_EQUATION_GRICCATI_SO1 creates an instance which represents
%   the corresponding Riccati equation for the above ODE.
%
...
%
%   MESS_EQUATION_GRICCATI_SO1 properties:
%       M           - real, sparse, n-by-n matrix.
%       D           - real, sparse, n-by-n matrix.
%       K           - real, sparse, n-by-n matrix.
%       B           - real, dense,  n-by-p or p-by-2n matrix.
%       C           - real, dense,  q-by-2n or n-by-q matrix.
...
%
%   See also MESS_EQUATION_GRICCATI_SO2, MESS_LRNM, MESS_OPTIONS.
%
%   References:
...
classdef mess_equation_griccati_so1 < base_equation
    ...
    methods
        ...
        function obj = mess_equation_griccati_so1(opt, M, D, K, B, C, lowerbound, upperbound)
            % Create instance from given arguments.
            %   eqn = MESS_EQUATION_GRICCATI_SO1(opt, M, D, K, B, C, lowerbound, upperbound) returns

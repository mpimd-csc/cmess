% MESS_EQUATION_GLYAP_SO1 Class represents a Second Order system Lyapunov Equation.
%
%   MESS_EQUATION_GLYAP_SO1 represents a Second Order system:
%
%   M x''  +  D x' + K x = Bu
%
...
%   |  0, M | | x'' |   | -K, -D | | x' |   | B |
%
%   MESS_EQUATION_GLYAP_SO1 creates an instance which represents
...
%
%   MESS_EQUATION_GLYAP_SO1 properties:
...
%
%   See also MESS_EQUATION_GLYAP_SO2, MESS_LRADI, MESS_OPTIONS.
%
%   References:
...
classdef mess_equation_glyap_so1 < base_equation
    ...
    methods
        ...
        function obj = mess_equation_glyap_so1(opt, M, D, K, B, lowerbound, upperbound)
            % Create instance from given arguments.
            %   eqn = MESS_EQUATION_GLYAP_SO1(opt, M, D, K, B, lowerbound, upperbound) returns

% MESS_EQUATION_GRICCATI_SO2 Class represents a Second Order system Riccati Equation.
%
%   MESS_EQUATION_GRICCATI_SO2 represents a Second Order system:
%
%   M x''  +  D x' + K x = Bu,
%                      y = Cx
%
...
%                  y  =  C x.
%
%   MESS_EQUATION_GRICCATI_SO2 creates an instance which represents
...
%
%   MESS_EQUATION_GRICCATI_SO2 properties:
...
%
%   See also MESS_EQUATION_GRICCATI_SO1, MESS_LRNM, MESS_OPTIONS.
%
%   References:
...
classdef mess_equation_griccati_so2 < base_equation
    ...
    methods
        ...
        function obj = mess_equation_griccati_so2(opt, M, D, K, B, C, lowerbound, upperbound)
            % Create instance from given arguments.
            %   eqn = MESS_EQUATION_GRICCATI_SO2(opt, M, D, K, B, C, lowerbound, upperbound) returns

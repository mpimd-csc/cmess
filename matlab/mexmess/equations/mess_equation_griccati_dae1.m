% MESS_EQUATION_GRICCATI_DAE1 Class represents a Index 1 system Riccati Equation.
%
%   MESS_EQUATION_GRICCATI_DAE1 represents a Index 1 system:
%
...
%   Lyapunov equations.
%
%   MESS_EQUATION_GRICCATI_DAE1 properties:
...
%       B       - real, dense,  n1-by-p  or (n1+n2)-by-p matrix.
%       C       - real, dense,  q-by-(n1+n2) or q-by-n1 matrix.
%       dim     - state space dimension of the underlying ODE.
%
%   See also MESS_EQUATION_GLYAP_DAE1, MESS_LRNM, MESS_OPTIONS.
%
%   References:
...
classdef mess_equation_griccati_dae1 < base_equation
    ...
    methods
        ...
        function obj = mess_equation_griccati_dae1(opt, E11, A11, A12, A21, A22, B, C)
            % Create instance from given arguments.
            %   eqn = MESS_EQUATION_GRICCATI_DAE1(opt, E11, A11, A12, A21, A22, B, C) returns

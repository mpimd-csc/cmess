% TEST_LRNM_TRIPLE_CHAIN_SO1 test for <a href="matlab:help mess_lrnm">mess_lrnm</a> using <a href="matlab:help mess_equation_griccati_so1">mess_equation_griccati_so1</a>.
%
%   TEST_LRNM_TRIPLE_CHAIN_SO1 tests the <a href="matlab:help mess_lrnm">mess_lrnm</a> solver.
%   TEST_LRNM_TRIPLE_CHAIN_SO1 creates a Riccati equation using <a href="matlab:help mess_equation_griccati_so1">mess_equation_griccati_so1</a> and solves it.
%
%   TEST_LRNM_TRIPLE_CHAIN_SO1 properties:
...
%
%   See also MESS_LRNM, MESS_EQUATION_GRICCATI_SO1.
%
...
classdef test_lrnm_triple_chain_so1 < matlab.unittest.TestCase
    ...
    methods
        function template_so1(test)
            % build equation
            eqn = mess_equation_griccati_so1(test.opt,test.M,test.D,test.K,test.B,test.C,test.lowerbound, test.upperbound);
    ...
    methods(Test)
        ...
        function test_riccati_so1(test)
        ...
        function test_dual_riccati_so1(test)

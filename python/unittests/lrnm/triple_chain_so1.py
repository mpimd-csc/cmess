...
"""Test lrnm function for triple chain instance, so1 function handles."""
from __future__ import print_function, division
import unittest
from scipy.io import mmread
import numpy as np
from pymess import EquationGRiccatiSO1, Options, lrnm, MESS_OP_NONE, MESS_OP_TRANSPOSE


class TripleChainSO1(unittest.TestCase):
    """Test lrnm function for triple chain instance, so1 function handles."""
    ...
    def template_so1(self, mytype):
        ...
        #build equation
        eqn = EquationGRiccatiSO1(self.opt, self.m, self.d, self.k, b, c, self.lowerbound, self.upperbound)
    ...
    def test_lrnm_so1_n(self):
        """test"""
        self.template_so1(MESS_OP_NONE)

    def test_lrnm_so1_t(self):
        """test"""
        self.template_so1(MESS_OP_TRANSPOSE)
    ...
    def run(self, result=None):
        ...
        if not result.errors:
            super(TripleChainSO1, self).run(result)

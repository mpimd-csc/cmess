...
"""Test lradi function for triple chain instance, so1 function handles."""
from __future__ import print_function, division
import unittest
from scipy.io import mmread
import numpy as np
from pymess import EquationGLyapSO1, Options, lradi, MESS_OP_NONE, MESS_OP_TRANSPOSE, MESS_LRCFADI_PARA_MINMAX
...
class TripleChainSO1(unittest.TestCase):
    ...
    def template_so1(self, mytype):
        ...
        #build equation
        eqn = EquationGLyapSO1(self.opt, self.m, self.d, self.k, b if self.opt.type == MESS_OP_NONE else c,

 ...
 * @file python/c_interface/conv/eqn/so2.c
 * @brief Equation conversion for so2 function handles.
 * @author @mbehr
 *
 */
...
/*-----------------------------------------------------------------------------
 *  Convert a pymess.EquationGLyapSO2 to mess_equation_glyap_so2
 *-----------------------------------------------------------------------------*/
mess_equation eqn_conv_lyap_so2(PyObject *obj, mess_freelist mem) {
    ...
    ret = mess_equation_glyap_so2(eqn, opts, M, D, K, B, lowerbound, upperbound);
    if(ret){
...
/*-----------------------------------------------------------------------------
 *  Convert a pymess.EquationGRiccatiSO2 to mess_equation_riccati_so2
 *-----------------------------------------------------------------------------*/
mess_equation eqn_conv_riccati_so2(PyObject *obj, mess_freelist mem) {
    ...
    mess_equation_init(&eqn);
    mess_freelist_add_mess_equation(mem,eqn);
    ret = mess_equation_griccati_so2(eqn, opts, M, D, K, B, C, lowerbound, upperbound);
    if(ret){

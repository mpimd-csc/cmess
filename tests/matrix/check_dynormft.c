 ...
 * @{
 * @file tests/matrix/check_dynormft.c
 * @brief Check the Frobenius-norm computation of a transposed matrix.
 * @test
 * This function checks the @ref mess_matrix_dynormf function defined in dynorm.c for a transposed matrix \f$ G^T \f$ that
 * means it checks if the Frobenius-norm
 * \f[ \Vert G G^H \Vert_F \f]
...
int main ( int argc, char **argv){
    ...
    CALL(mess_matrix_dynormf(Gt,&nrm));

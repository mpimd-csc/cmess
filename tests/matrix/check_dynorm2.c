 ...
 * @{
 * @file tests/matrix/check_dynorm2.c
 * @brief Check the \f$ 2 \f$-norm computation of a matrix.
 * @test
 * This function checks the @ref mess_matrix_dynorm2 function defined in dynorm.c that means it checks if the
 * \f$ 2 \f$-norm of a matrix \f$ G \f$
 * \f[ \Vert G^H G \Vert_2 \f]
...
int main ( int argc, char **argv){
    ...
    CALL(mess_matrix_dynorm2(G,&nrm));

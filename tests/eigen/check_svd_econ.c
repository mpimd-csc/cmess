 ...
 * @{
 * @file tests/eigen/check_svd_econ.c
 * @brief Check the economy size singular value decomposition.
 * @author @koehlerm
 * @test
 *
...
int main ( int argc, char ** argv) {
    mess_init();
    mess_matrix A,U1,V1,U2,V2,tmp,eye;
    ...
    CALL(mess_matrix_eye(eye,n,n,MESS_DENSE));
    ...
    CALL(mess_matrix_eye(eye, tmp->rows, tmp->cols,MESS_DENSE));
